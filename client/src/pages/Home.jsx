    ...
    <section className="max-w-7xl mx-auto" >
        <div>
            ...
            <p className="mt-2 text-[#666e75] text-[14px] max-w[500px]">
                Browse through a collection of iumaginative and visually stunning image generated by DALL-E AI
            </p>
        </div>
            ...
            {loading?(
                ...
                {searchText && (
                    <h2 className='font-medium text-[#666e75] text-xl mb-3'>
                        Showing  results for <span className='text-[#222328] text-blue-600'>{searchText}</span>
                    </h2>
                )}
